...
<div
	class="fixed grid h-dvh w-screen grid-cols-1 grid-rows-[auto,1fr] overflow-hidden bg-white text-smd text-gray-900 dark:bg-gemini-surface dark:text-gemini-onSurface {!isNavCollapsed
